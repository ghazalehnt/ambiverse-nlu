...
public class EntityConceptSpottingSeparateDisambiguation extends Pipeline {
    @Override
    void addSteps() {
        for (Language language : supportedLanguages()) {
            ...
            addstep(Component.FILTER_CONCEPTS_BY_POS_NOUNPHRASES_NEs.name(), Component.AIDA_NO_RESULTS.name());
            addstep(Component.AIDA_NO_RESULTS.name(), Component.CD_USE_RESULTS.name());
        }
    }
